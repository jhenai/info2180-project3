...
try {
       ...
       $usernameErr = $passwordErr = $username = $password = "";
        ...
        //echo $sql;
            ...
            if($result->num_rows == 0) {
                echo "<script> alert('user does not exist'); return false;</script>";
  ...
  //echo "<script> window.location.href = 'no-refresh.php'; </script>";  // send them to the home page on a succesfull login
             //include 'index.php';
